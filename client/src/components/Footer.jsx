    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 bg-primary/3'>
      ...
      py-10 border-b border-gray-500/30 text-gray-500'>
        <div>
            ...
            <p className='max-w-[410px] mt-6'>Discover inspiring blogs, share your voice, and stay updated with the latest in tech, startups, lifestyle, and more. Your story starts here.</p>
        </div>
